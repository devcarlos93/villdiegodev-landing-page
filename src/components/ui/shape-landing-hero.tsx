...
function HeroGeometric({
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#1a1a2e]">
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500/[0.05] via-transparent to-cyan-500/[0.05] blur-3xl" />
      
      <div className="absolute inset-0 overflow-hidden">
        {/* Particles/Shapes removed as per user request */}
      </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                ...
                <span
                  className={cn(
                    "bg-clip-text text-transparent bg-gradient-to-r from-orange-300 via-white/90 to-cyan-300"
                  )}
                >
                  {title2}
                </span>
